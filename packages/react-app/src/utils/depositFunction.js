...
async function sendMetaTx(tokenAddress, amount, phoneNumber, signer, provider) {
...
export async function depositToken(
  ...
  if (!tokenAddress) throw new Error(`tokenAddress cannot be empty`)
  ...
  return sendMetaTx(tokenAddress, amount, phoneNumber, signer, provider)
}
